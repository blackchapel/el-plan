  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post(
        "https://el-plan-production.up.railway.app/api/auth/login",
        {
          email: email,
          password: password,
        }
          ...
          >
            <Stack spacing={4}>
              ...
              <Text color={"#563300"} fontSize={{ base: "sm", sm: "md" }}>
                We believe that every sip should be an experience to remember,
                whether you're looking for a quick caffeine boost to start your
                day or a relaxing afternoon pick-me-up.
              </Text>
            </Stack>
            <Box as={"form"} mt={10}>
              <Stack spacing={4}>
